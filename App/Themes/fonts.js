...
const widthPercentageToDP = (iphoneWidthPercent, androidWidthPercent = iphoneWidthPercent) => {
    const elemWidth =
...
export const HeightPercentageToDP = (iphoneHeightPercent, androidHeightPercent = iphoneHeightPercent) => {
    const elemHeight =
...
export const dimensions = {
    topExtraSpace: 6,
    roundBtnHeight: Math.min(deviceDimensions.height, deviceDimensions.width) * 0.2,
...
export { AR_12_18, QB_13, AB_14, QB_24, AR_16, AR_12, QB_14_18, QM_13_21 };
